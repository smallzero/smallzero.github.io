...
Gem::Specification.new do |spec|
  ...
  spec.version       = "0.9"
  spec.authors       = ["Agus Rochmad Tri Rharjo"]
  spec.email         = ["agus.rochmad.tr@gmail.com"]

  spec.summary       = "DevOps and Software Engineer"
  spec.homepage      = "https://smallzero.github.com"
  spec.license       = "MIT"
